...
<nav class="navbar navbar-expand-lg bg-white">
  ...
  <img src="../img/nav.png" alt="Logo" width="130" height="70" class="d-inline-block align-text-top">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link" aria-current="page" href="c_admins.php" >Crear Administradores</a>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="c_asignaturas.php" >Crear Asignaturas</a>
        </li>
        <li class="nav-item">
...
<div class="container shadow-lg rounded p-4 mt-3">
  <form>
  <div class="container">
  <div class=" bg-red text-white text-center rounded h1 ">Crear Asignatura</div>
    <div class="row mt-3">
